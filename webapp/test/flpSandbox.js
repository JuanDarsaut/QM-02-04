		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Aplicación de números de serie",
									"targetURL": "#customerzlomansernumzlomansernum-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"customerzlomansernumzlomansernum-display": {
								"semanticObject": "customerzlomansernumzlomansernum",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=customer.zlomansernum.zlomansernum",
									"url": sap.ui.require.toUrl("customer/zlomansernum/zlomansernum")
								}
							}
						}
					}
